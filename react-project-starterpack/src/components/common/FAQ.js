    ...
    return (
      ...
      <section className="section">
        <div className="container">
          ...
          <hr/>
          <hr/>
          <Collapsible trigger = 'The Game'>
            <p>Geocaching is a real-world, outdoor treasure hunting game using GPS-enabled devices. Participants navigate to a specific set of GPS coordinates and then attempt to find the geocache *container* hidden at that location.</p>
          </Collapsible>
          <hr/>
          <Collapsible trigger = 'How is the game played ?'>
            <ul>
          ...
          <hr/>
          <Collapsible trigger = 'What are the rules of geocaching?'>
            <ul> 
          ...
          <hr/>
          <Collapsible trigger = 'What do I need to go geocaching?'>
            <p>The only necessities are a GPS device or a GPS-enabled mobile phone so that you can navigate to the cache.</p>
          </Collapsible>
          <hr/>
          <Collapsible trigger = 'Where are geocaches located?'>
            <p>Geocaches can be found all over the world. It is common for geocachers to hide caches in locations that are important to them, reflecting a special interest or skill of the cache owner. These locations can be quite diverse. They may be at your local park, at the end of a long hike, underwater or on the side of a city street.</p>
          </Collapsible>
        </div>
      </section>
      </>
